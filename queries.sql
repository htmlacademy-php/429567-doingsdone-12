...
INSERT INTO tasks (task, date_end, project_id, user_id) VALUES ('Собеседование в IT компании', '18.12.2021', (SELECT p.id FROM projects p JOIN users u ON project = 'Работа' AND user_id = (SELECT u.id FROM users u WHERE u.userName = 'test1')), (SELECT u.id FROM users u WHERE u.userName = 'test1')); /*Добавление задачи для проекта Работа юзеру test1*/
INSERT INTO tasks (task, date_end, project_id, user_id) VALUES ('Выполнить тестовое задание', '10.09.2021', (SELECT p.id FROM projects p JOIN users u ON project = 'Работа' AND user_id = (SELECT u.id FROM users u WHERE u.userName = 'test2')), (SELECT u.id FROM users u WHERE u.userName = 'test2')); /*Добавление задачи для проекта Работа юзеру test2*/
INSERT INTO tasks (task, date_end, project_id, user_id, status) VALUES ('Сделать задание первого раздела', '10.09.2021', (SELECT p.id FROM projects p JOIN users u ON project = 'Учеба' AND user_id = (SELECT u.id FROM users u WHERE u.userName = 'test1')), (SELECT u.id FROM users u WHERE u.userName = 'test1'), '1'); /*Добавление задачи для проекта Учеба юзеру test1*/
INSERT INTO tasks (task, date_end, project_id, user_id) VALUES ('Встреча с другом', '10.09.2021', (SELECT p.id FROM projects p JOIN users u ON project = 'Входящие' AND user_id = (SELECT u.id FROM users u WHERE u.userName = 'test1')), (SELECT u.id FROM users u WHERE u.userName = 'test1')); /*Добавление задачи для проекта Входящие  юзеру test1*/
INSERT INTO tasks (task, date_end, project_id, user_id) VALUES ('Купить корм для кота', '10.09.2021', (SELECT p.id FROM projects p JOIN users u ON project = 'Домашние дела' AND user_id = (SELECT u.id FROM users u WHERE u.userName = 'test2')), (SELECT u.id FROM users u WHERE u.userName = 'test2')); /*Добавление задачи для проекта Домашние дела юзеру test2*/
INSERT INTO tasks (task, date_end, project_id, user_id) VALUES ('Заказать пиццу', '10.09.2021', (SELECT p.id FROM projects p JOIN users u ON project = 'Домашние дела' AND user_id = (SELECT u.id FROM users u WHERE u.userName = 'test2')), (SELECT u.id FROM users u WHERE u.userName = 'test2')); /*Добавление задачи для проекта Домашние дела юзеру test2*/
